...
I'm a software engineer working primarily in Java (Spring Boot) and TypeScript (Angular). I graduated from law school but decided to change careers to software engineering and I'm loving it💙 I first learned coding in Python, then Java, and then JavaScript.
